...
namespace Mebeller.Data.Services.Interfaces
{
    public interface IMediaService
    {
        ...
        public Task<bool> AddCommentToProductAsync(ProductsViewModel productViewModel);
        public Task<bool> AddReplyToProductCommentAsync(ProductsViewModel productViewModel);
