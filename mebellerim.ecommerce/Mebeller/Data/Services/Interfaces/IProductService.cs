...
public interface IProductService
{
    ...
    Task<IEnumerable<OrderViewModel>> GetOrdersListViewAsync();       
    Task<IEnumerable<OrderViewModel>> GetLoggedUserOrdersAsync();
    Task<OrderViewModel> GetOrderForEditAsync(int orderId);
    Task<Order> GetLoggedInUserOpenOrderAsync();
